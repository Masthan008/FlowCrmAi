...
export const createDealSchema = z.object({
  body: z.object({
    ...
    primaryContactId: z.string().uuid('Invalid contact ID').optional().nullable().or(z.literal('')),
    leadId: z.string().uuid('Invalid lead ID').optional().nullable().or(z.literal('')),
    pipelineId: z.string().uuid('Invalid pipeline ID').optional().nullable().or(z.literal('')),
    stageId: z.string().uuid('Invalid stage ID').optional().nullable().or(z.literal('')),
    ...
    actualCloseDate: z.string().optional().or(z.literal('')),
