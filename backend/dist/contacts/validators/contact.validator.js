...
exports.createContactSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        profilePhoto: zod_1.z.string().optional().or(zod_1.z.literal('')),
        ...
        website: zod_1.z.string().max(300).optional().or(zod_1.z.literal('')),
        // Socials
        linkedin: zod_1.z.string().max(300).optional().or(zod_1.z.literal('')),
        twitter: zod_1.z.string().max(300).optional().or(zod_1.z.literal('')),
        facebook: zod_1.z.string().max(300).optional().or(zod_1.z.literal('')),
        instagram: zod_1.z.string().max(300).optional().or(zod_1.z.literal('')),
        // Address
