...
exports.createDealSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        customerId: zod_1.z.string().uuid('Invalid customer ID').optional().nullable().or(zod_1.z.literal('')),
        companyId: zod_1.z.string().uuid('Invalid company ID').optional().nullable().or(zod_1.z.literal('')),
        primaryContactId: zod_1.z.string().uuid('Invalid contact ID').optional().nullable().or(zod_1.z.literal('')),
        leadId: zod_1.z.string().uuid('Invalid lead ID').optional().nullable().or(zod_1.z.literal('')),
        pipelineId: zod_1.z.string().uuid('Invalid pipeline ID').optional().nullable().or(zod_1.z.literal('')),
        stageId: zod_1.z.string().uuid('Invalid stage ID').optional().nullable().or(zod_1.z.literal('')),
