...
const companyKYC_controller_1 = require("../controllers/companyKYC.controller");
...
router.get('/cvr/lookup', (0, permission_1.requirePermission)('companies:view'), companyKYC_controller_1.companyKYCController.searchCVR);
...
router.get('/:id/kyc', (0, permission_1.requirePermission)('companies:view'), companyKYC_controller_1.companyKYCController.getKYC);
router.post('/:id/kyc', (0, permission_1.requirePermission)('companies:edit'), companyKYC_controller_1.companyKYCController.updateKYC);
...
router.post('/:id/activities', (0, permission_1.requirePermission)('companies:edit'), (0, validate_1.validateRequest)(companyActivity_validator_1.createCompanyActivitySchema), (0, activityLogger_1.logActivity)('companies', 'ACTIVITY_CREATED'), companyActivity_controller_1.companyActivityController.create);
router.put('/:id/activities/:activityId', (0, permission_1.requirePermission)('companies:edit'), (0, validate_1.validateRequest)(companyActivity_validator_1.updateCompanyActivitySchema), (0, activityLogger_1.logActivity)('companies', 'ACTIVITY_UPDATED'), companyActivity_controller_1.companyActivityController.update);
router.delete('/:id/activities/:activityId', (0, permission_1.requirePermission)('companies:edit'), (0, activityLogger_1.logActivity)('companies', 'ACTIVITY_DELETED'), companyActivity_controller_1.companyActivityController.delete);
// 360 Workspace: Notes
...
router.post('/:id/notes', (0, permission_1.requirePermission)('companies:edit'), (0, validate_1.validateRequest)(companyNote_validator_1.createCompanyNoteSchema), (0, activityLogger_1.logActivity)('companies', 'NOTE_ADDED'), companyNote_controller_1.companyNoteController.create);
router.put('/:id/notes/:noteId', (0, permission_1.requirePermission)('companies:edit'), (0, validate_1.validateRequest)(companyNote_validator_1.updateCompanyNoteSchema), (0, activityLogger_1.logActivity)('companies', 'NOTE_UPDATED'), companyNote_controller_1.companyNoteController.update);
router.delete('/:id/notes/:noteId', (0, permission_1.requirePermission)('companies:edit'), (0, activityLogger_1.logActivity)('companies', 'NOTE_DELETED'), companyNote_controller_1.companyNoteController.delete);
// 360 Workspace: Files
...
router.post('/:id/files', (0, permission_1.requirePermission)('companies:edit'), upload_1.upload.single('file'), (0, activityLogger_1.logActivity)('companies', 'FILE_UPLOADED'), companyFile_controller_1.companyFileController.create);
router.delete('/:id/files/:fileId', (0, permission_1.requirePermission)('companies:edit'), (0, activityLogger_1.logActivity)('companies', 'FILE_DELETED'), companyFile_controller_1.companyFileController.delete);
