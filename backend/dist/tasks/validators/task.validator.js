...
exports.createTaskSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        relatedRecordId: zod_1.z.string().optional().nullable(),
        assignedToId: zod_1.z.string().optional().nullable(),
        assignedById: zod_1.z.string().optional().nullable(),
        ...
        progressPercentage: zod_1.z.number().int().min(0).max(100).optional().default(0),
...
exports.updateTaskSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        reminderDate: zod_1.z.string().optional().nullable(),
        reminderTime: zod_1.z.string().optional().nullable(),
        progressPercentage: zod_1.z.number().int().min(0).max(100).optional(),
