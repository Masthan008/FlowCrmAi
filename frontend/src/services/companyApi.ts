...
export const companyApi = {
  ...
  getSegments: (params?: any) => api.get(`${COMPANIES_URL}/company-segments`, { params }),
  createSegment: (data: any) => api.post(`${COMPANIES_URL}/company-segments`, data),
  getSegment: (id: string) => api.get(`${COMPANIES_URL}/company-segments/${id}`),
  updateSegment: (id: string, data: any) => api.put(`${COMPANIES_URL}/company-segments/${id}`, data),
  deleteSegment: (id: string) => api.delete(`${COMPANIES_URL}/company-segments/${id}`),
  evaluateSegment: (id: string) => api.post(`${COMPANIES_URL}/company-segments/${id}/evaluate`),
  getTags: (params?: any) => api.get(`${COMPANIES_URL}/company-tags`, { params }),
  createTag: (data: any) => api.post(`${COMPANIES_URL}/company-tags`, data),
  updateTag: (id: string, data: any) => api.put(`${COMPANIES_URL}/company-tags/${id}`, data),
  deleteTag: (id: string) => api.delete(`${COMPANIES_URL}/company-tags/${id}`),
  ...
  getWorkflows: (params?: any) => api.get(`${COMPANIES_URL}/company-workflows`, { params }),
  createWorkflow: (data: any) => api.post(`${COMPANIES_URL}/company-workflows`, data),
  updateWorkflow: (id: string, data: any) => api.put(`${COMPANIES_URL}/company-workflows/${id}`, data),
  deleteWorkflow: (id: string) => api.delete(`${COMPANIES_URL}/company-workflows/${id}`),
  ...
  getInsights: () => api.get(`${COMPANIES_URL}/company-insights`),
  getAnalytics: (params?: any) => api.get(`${COMPANIES_URL}/company-analytics`, { params }),
